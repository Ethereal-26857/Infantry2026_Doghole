...
class TxMgr : public MemMgr
{
 public:
   ...
   */
  void setTransmitterNeedToTransmit(Transmitter *transmitter_ptr);
   ...
   * @note        不建议在发送过程中移除发送端
   */
  bool deleteTransmitter(Transmitter *transmitter_ptr);
 ...
 protected:
  typedef tools::list<Transmitter*> TransmitterPtrList;
  ...
  TransmitterPtrList transmitter_ptr_list_;
};
/* Exported variables --------------------------------------------------------*/
