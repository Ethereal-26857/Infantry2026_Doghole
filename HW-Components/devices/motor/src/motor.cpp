                   ...
                   const OptionalParams& opt)
{
  switch (motor_type) {
    ...
    case MotorType::kDM_J6006:
      return new DM_J6006(id, opt);
    case MotorType::kDM_J8006:
      return new DM_J8006(id, opt);
    case MotorType::kDM_J8009:
      return new DM_J8009(id, opt);
    case MotorType::KDrEmpower:
      return new DrEmpower(id, opt);
    ...
    case MotorType::kMG5010Ei36:
      return new MG5010Ei36(id, opt);
    case MotorType::kGO_M8010:
      return new GO_M8010(id, opt);
    case MotorType::kJC2804:
      return new JC2804(id, opt);
    default:
